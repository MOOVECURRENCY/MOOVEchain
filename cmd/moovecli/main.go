...
import (
	...
	"github.com/MOOVECURRENCY/moovechain"
	"github.com/MOOVECURRENCY/moovechain/types"
)
...
func main() {
	...
	cmd := &cobra.Command{
		Use:   "moovecli",
		Short: "MOOVECURRENCY command line interface",
	}
	...
	executor := cli.PrepareMainCmd(cmd, "MOOVECHAIN", hub.DefaultCLIHome)
